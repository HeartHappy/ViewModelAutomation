...
@BindStateFlow(
    methodName = "register",
    requestClass = ReRegister::class,
    responseClass = ResRegister::class
) @BindLiveData(
    methodName = "login2",
    requestClass = ReLoginBean::class,
    responseClass = ResLoginBean::class
)
@BindLiveData(methodName = "delete", requestClass = ReDelete::class, responseClass = String::class)
@BindLiveData(
    methodName = "userInfo",
    requestClass = ReUserInfo::class,
    ...
    fun btnRequest2(view: View) {
        ...
        val token =
            "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..pvJKgwwZ0g3xGCyI7yCSz5Z_iudbBVb0DDGMsyuPbPGCmZa5z5EMqLTB6cKwUpe8yu3BWAE7Z6FSxoVAw4U1HDP4Ilo_5OJubwIDagWkhGdR65aKDE5UHJVH_js8dlkVk9r31IAFohToUFqCzm4gR7E4pyuW1z4B4QMFbtvkZzbb1ZinmRAG21zJfTg8MjjCVIRiftDAf7CkB0E5kkIXPLXYl8HzhbXG6k22AZCqrg0-lD-fbd85ORbifh5Twh6dEcfmJsIub027PISdG1glj534tXwFT15UchtuCs4lusM84F9SA_DyUHvC0aJ0FNB60w2bbi3lFjK_WdJ3-SD-Iw"
